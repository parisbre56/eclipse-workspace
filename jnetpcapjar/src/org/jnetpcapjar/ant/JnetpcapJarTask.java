...
import org.jnetpcapjar.JnetpcapLoader;

public class JnetpcapJarTask extends Jar
{
  ...
  public void execute() throws BuildException
  {
    ...
    try
    {
      ...
      swtAttrs.getMainSection().addConfiguredAttribute(new Attribute(JnetpcapLoader.JNETPCAPJAR_MAIN_CLASS, targetmainclass));
      swtAttrs.getMainSection().addConfiguredAttribute(new Attribute("Main-Class", JnetpcapLoader.class.getName()));
    ...
    zset.setIncludes("**/jarinjarloader/**/*.class,**/JnetpcapLoader*.class");
    addZipfileset(zset);
